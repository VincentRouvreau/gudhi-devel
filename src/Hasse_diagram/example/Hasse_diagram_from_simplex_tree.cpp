...
int main() {
  ...
  std::vector<std::vector<double> > circle_pt_cloud = {{0, 1},
                                                       {0.0998334166, 0.9950041653},
                                                       {0.1986693308, 0.9800665778},
                                                       {0.2955202067, 0.9553364891},
                                                       {0.3894183423, 0.921060994},
                                                       {0.4794255386, 0.8775825619},
                                                       {0.5646424734, 0.8253356149},
                                                       {0.6442176872, 0.7648421873},
                                                       {0.7173560909, 0.6967067093},
                                                       {0.7833269096, 0.6216099683},
                                                       {0.8414709848, 0.5403023059},
                                                       {0.8912073601, 0.4535961214},
                                                       {0.932039086, 0.3623577545},
                                                       {0.9635581854, 0.2674988286},
                                                       {0.98544973, 0.1699671429},
                                                       {0.9974949866, 0.0707372017},
                                                       {0.999573603, -0.0291995223},
                                                       {0.9916648105, -0.1288444943},
                                                       {0.9738476309, -0.2272020947},
                                                       {0.9463000877, -0.3232895669},
                                                       {0.9092974268, -0.4161468365},
                                                       {0.8632093666, -0.5048461046},
                                                       {0.8084964038, -0.5885011173},
                                                       {0.7457052122, -0.6662760213},
                                                       {0.6754631806, -0.7373937155},
                                                       {0.5984721441, -0.8011436155},
                                                       {0.5155013718, -0.8568887534},
                                                       {0.4273798802, -0.904072142},
                                                       {0.3349881502, -0.9422223407},
                                                       {0.2392493292, -0.9709581651},
                                                       {0.1411200081, -0.9899924966},
                                                       {0.0415806624, -0.9991351503},
                                                       {-0.0583741434, -0.9982947758},
                                                       {-0.1577456941, -0.9874797699},
                                                       {-0.255541102, -0.9667981926},
                                                       {-0.3507832277, -0.9364566873},
                                                       {-0.4425204433, -0.8967584163},
                                                       {-0.5298361409, -0.8481000317},
                                                       {-0.6118578909, -0.7909677119},
                                                       {-0.6877661592, -0.7259323042},
                                                       {-0.7568024953, -0.6536436209},
                                                       {-0.8182771111, -0.5748239465},
                                                       {-0.8715757724, -0.4902608213},
                                                       {-0.9161659367, -0.4007991721},
                                                       {-0.9516020739, -0.30733287},
                                                       {-0.9775301177, -0.2107957994},
                                                       {-0.9936910036, -0.1121525269},
                                                       {-0.9999232576, -0.0123886635},
                                                       {-0.9961646088, 0.0874989834},
                                                       {-0.9824526126, 0.1865123694},
                                                       {-0.9589242747, 0.2836621855},
                                                       {-0.9258146823, 0.3779777427},
                                                       {-0.8834546557, 0.4685166713},
                                                       {-0.8322674422, 0.5543743362},
                                                       {-0.7727644876, 0.6346928759},
                                                       {-0.7055403256, 0.7086697743},
                                                       {-0.6312666379, 0.7755658785},
                                                       {-0.5506855426, 0.8347127848},
                                                       {-0.4646021794, 0.8855195169},
                                                       {-0.3738766648, 0.9274784307},
                                                       {-0.2794154982, 0.9601702867},
                                                       {-0.1821625043, 0.9832684384},
                                                       {-0.0830894028, 0.996542097},
                                                       {0.0168139005, 0.9998586364}};
